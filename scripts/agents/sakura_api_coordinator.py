"""scripts/agents/sakura_api_coordinator.py — Sakura API Coordinator (リリース部 Phase 6)"""
import logging
from agents._base import check_inputs, setup_agent_logging

AGENT_ID = "sakura_api_coordinator"
REQUIRED_INPUTS = ["artifacts/product/prd.md"]
OUTPUTS = ["artifacts/design/api_connectivity_report.md"]
